...
cars.cars.forEach((e)=>{
  let a=L.marker([e.location[1],e.location[0]], {icon:e.status=== "GREEN_CARD"?greenIcon:e.status==="NO_BORDER"?redIcon:e.status==="US_CITIZEN"?blueIcon:yellowIcon}).addTo(map);
